...
namespace DBUtility
{
    ...
    {
        //创建系统日志
        protected static LogHelper Logger = new LogHelper();
        ...
        public static int ExecuteSql(string SQLString)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand(SQLString, connection))
                {
                    ...
                    {
                        connection.Close();
                        Logger.writeInfos("-----------执行简单SQL语句，返回影响的记录数-----------\r\n" + SQLString + "\r\n" + e.Message + "\r\n");
                        throw e;
                    }
                }
            }
        ...
        public static int ExecuteSql(SqlConnection connection, SqlTransaction trans, string SQLString)
        {
            using (SqlCommand cmd = new SqlCommand(SQLString, connection))
            {
                ...
                {
                    //trans.Rollback();
                    Logger.writeInfos("-----------执行SQL语句，返回影响的记录数-----------\r\n" + SQLString + "\r\n" + e.Message + "\r\n");
                    throw e;
                }
            }
        }
        ...
        public static int ExecuteSqlByTime(string SQLString, int Times)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand(SQLString, connection))
                {
                    ...
                    {
                        connection.Close();
                        Logger.writeInfos("-----------执行简单SQL语句ExecuteSqlByTime-----------\r\n" + SQLString + "\r\n" + e.Message + "\r\n");
                        throw e;
                    }
                }
            }
        ...
        public static int ExecuteSqlTran(List<CommandInfo> list, List<CommandInfo> oracleCmdSqlList)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    tx.Rollback();
                    Logger.writeInfos("-----------执行Sql和Oracle滴混合事务ExecuteSqlTran-----------\r\n" + e.Message + "\r\n");
                    throw e;
                }
                catch (Exception e)
                {
        ...
        public static int ExecuteSqlTran(List<String> SQLStringList)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    tx.Rollback();
                    Logger.writeInfos("-----------执行多条SQL语句，实现数据库事务ExecuteSqlTran-----------\r\n" + e.Message + "\r\n");
                    return 0;
                }
            }
        }
        ...
        public static int ExecuteSql(string SQLString, string content)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    Logger.writeInfos("-----------执行带一个存储过程参数的的SQL语句ExecuteSql-----------\r\n" + SQLString + "\r\n" + e.Message + "\r\n");
                    throw e;
                }
                finally
                {
        ...
        public static object ExecuteSqlGet(string SQLString, string content)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    Logger.writeInfos("-----------执行带一个存储过程参数的的SQL语句ExecuteSqlGet-----------\r\n" + SQLString + "\r\n" + e.Message + "\r\n");
                    throw e;
                }
                finally
                {
        ...
        public static int ExecuteSqlInsertImg(string strSQL, byte[] fs)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    Logger.writeInfos("-----------向数据库里插入图像格式的字段(和上面情况类似的另一种实例)ExecuteSqlInsertImg-----------\r\n" + strSQL + "\r\n" + e.Message + "\r\n");
                    throw e;
                }
                finally
                {
        ...
        public static object GetSingle(string SQLString)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand(SQLString, connection))
                {
                    ...
                    {
                        connection.Close();
                        Logger.writeInfos("-----------执行一条计算查询结果语句，返回查询结果（object）GetSingle-----------\r\n" + SQLString + "\r\n" + e.Message + "\r\n");
                        throw e;
                    }
                }
            }
        ...
        public static SqlDataReader ExecuteReader(string strSQL)
        {
            ...
            {
                Logger.writeInfos("-----------执行查询语句，返回SqlDataReader ( 注意：调用该方法后，一定要对SqlDataReader进行Close )ExecuteReader-----------\r\n" + strSQL + "\r\n" + e.Message + "\r\n");
                throw e;
            }
        ...
        public static int ExecuteSql(string SQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    {
                        Logger.writeInfos("----------- 执行SQL语句，返回影响的记录数ExecuteSql-----------\r\n" + SQLString + "\r\n" + e.Message + "\r\n");
                        throw e;
                    }
                    catch (Exception e)
                    {
        ...
        public static void ExecuteSqlTranWithIndentity(System.Collections.Generic.List<CommandInfo> SQLStringList)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    ...
                    {
                        Logger.writeInfos("----------- 执行多条SQL语句，实现数据库事务ExecuteSqlTranWithIndentity-----------\r\n" + e.Message + "\r\n");
                        trans.Rollback();
                        throw;
                    }
                }
        ...
        public static void ExecuteSqlTranWithIndentity(Hashtable SQLStringList)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    ...
                    {
                        Logger.writeInfos("----------- 执行多条SQL语句，实现数据库事务。ExecuteSqlTranWithIndentity-----------\r\n" + e.Message + "\r\n");
                        trans.Rollback();
                        throw;
                    }
                }
        ...
        public static DataSet Query(SqlConnection connection, SqlTransaction trans, string SQLString, params SqlParameter[] cmdParms)
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter(cmd))
            {
                ...
                {
                    Logger.writeInfos("----------- 执行查询语句，返回DataSetQuery-----------\r\n" + ex.Message + "\r\n");
                    //trans.Rollback();
                    throw new Exception(ex.Message);
                }
                return ds;
